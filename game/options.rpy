...
define config.name = _("engsoft_reassemble_puzzle")
...
define build.name = "engsoft_reassemble_puzzle"
...
define config.save_directory = "engsoft_reassemble_puzzle-1695188674"
